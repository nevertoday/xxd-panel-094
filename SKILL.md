...
```text
/xxd-panel-094 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，094 设计在下）
2. 左右对照（原图在左，094 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-094/<fresh-task>/
...
- `references/xxd-panel-094-prompt.zh-CN.md`
- `references/xxd-panel-094-prompt.en.md`
