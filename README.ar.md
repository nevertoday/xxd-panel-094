...
حُجز موضع النماذج. ستُعرض هنا أولًا الأعمال الأصلية القابلة للتحقق أو النماذج الإضافية التي روجعت مباشرة وفق موجّه Panel 094؛ ولن تُستبدل بصور من رقم آخر أو بعناصر نائبة معطلة.
...
يحفظ **Panel 094** الهوية بمحيط دقيق، ثم ينسج الضوء والحجم والخامة بأسود فحمي عميق، هندسة تخطيطية، لون موضعي واحد مستخرج من الصورة، وحروف يدوية وحبيبات طباعة. تُفصّل المواضع المميزة فقط ويبقى سواها غير مكتمل عمدًا.
