<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 094" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 094｜كتاب كلاسيكي بلونين

### يحوّل الصورة إلى لوحة كتاب قديم بحبر رفيع ولون موضعي واحد وفراغ واسع
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 094 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

لا تحتاج الصورة إلى تتبّع كل حافة. يحتفظ Panel 094 بهوية العنصر وعاطفته، ويُبعد الخلفية المعقدة، ويجعل شكلاً واحداً وعلاقة واحدة ومساحة ورق واسعة تحمل السرد.

يشكّل **Panel 094** الموضوع بخطوط حبر رفيعة ومساحات سوداء موضعية وقليل من التهشير، ثم يستخرج لوناً موضعياً واحداً من الصورة. ويعيد بناء المشهد كصفحة هادئة من كتاب أطفال أو ديوان شعر من أوائل القرن العشرين، بفراغ سلبي واسع جداً وإطار زخرفي مرسوم يدوياً عند الحاجة وخط نشر كلاسيكي.

### مناسب لـ

- **الحفاظ على العنصر وحذف الضوضاء:** إبقاء ما يلزم فقط للهوية والوضع والعاطفة والعلاقة السردية؛
- **محبي الطباعة الكلاسيكية بلونين:** حبر أسود ولون واحد مشتق من الصورة فوق ورق عاجي مع انحراف طباعي خفيف؛
- **استخدام الفراغ كمعنى:** تصغير العنصر أو عزله أو إزاحته ليصبح البياض جزءاً من البنية الشعرية؛
- **التسليم المرن:** أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وخلفيات لأربع أجهزة ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 094 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** رسم بالحبر · أسود موضعي · لون واحد مستخرج · فراغ سلبي هائل · إطار يدوي · خط نشر كلاسيكي
...
|---|---|
| **الناتج** | رسم بلونين نظيف ومنضبط ومتنفس كصفحة افتتاحية من كتاب أطفال أو ديوان قديم |
| **البصمة الواضحة** | خط حبر رفيع، أسود موضعي، لون من الصورة، فراغ واسع، إطار زخرفي، وتنسيق كتاب كلاسيكي |
...
```text
تحليل الموضوع والمحيط والوضع والعلاقة السردية → حذف الخلفية المعقدة → التشكيل بخط حبر رفيع وأسود موضعي وقليل من التهشير → استخراج لون واحد من الصورة → إكمال سرد الصفحة بفراغ واسع وإطار اختياري وخط كلاسيكي
```

## سمات النتيجة النهائية

- تحافظ خطوط الحبر الرفيعة المنضبطة والأسود الموضعي والتهشير القليل على الهوية من دون مرشح تتبع للصورة.
- يصنع الحبر الأسود ولون واحد مستخرج من الصورة ومنقّى باعتدال إيقاع طباعة بلونين.
- يمكن أن يكون العنصر صغيراً أو معزولاً أو مزاحاً أو معلّقاً؛ فالفراغ الواسع بنية عاطفية لا نقصاً.
- يتصل النص ببياض الورق والإطار الاختياري كأنه ترويسة أو هامش أو إهداء من كتاب قديم.
- تُتجنب التلوينات الكاملة والخلفيات المعقدة والكرتون الحديث والمناظر المائية والخطوط الغليظة والتدرجات الرقمية و3D والقوالب التجارية.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-094-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 094. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-094 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-094 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-094 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-094 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-094 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 094 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-094 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-094`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-094-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-094-prompt.zh-CN.md)
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–094) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
